class UsuariosSistemaRequestModel {
  int id;
  ...
  factory UsuariosSistemaRequestModel.fromJson(Map<String, dynamic> json) {
    return UsuariosSistemaRequestModel(
      id: json['id'],
